...
func getTotalActiveNodeWithBond(ctx sdk.Context, k keep.Keeper) (int64, error) {
...
// Pays out Rewards
func payPoolRewards(ctx sdk.Context, k keep.Keeper, poolRewards []sdk.Uint, pools Pools) error {
